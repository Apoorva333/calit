...
description: calit supports English and German out of the box — for both booking visitors and account owners.
---

calit ships with English and German built in. No configuration or environment variables are required to enable either language — both are always available.
...
A **language switcher in the page footer** lets visitors choose between **English** and **Deutsch**. Selecting a language:
...
Go to **Settings** (accessible from the `/me` navigation) and find the **Language** field. Choose **English** or **Deutsch** and save. The change takes effect immediately.

## Adding more languages

Community contributions are welcome — adding a new language requires dropping in a translation file. See the project repository for details.
