...
class BookingServiceGuestTest {
    ...
    private Instant firstSlot() {
        ...
        java.time.LocalDate from = java.time.LocalDate.now(java.time.ZoneId.of("Europe/Amsterdam")).plusDays(1);
    ...
    void declineGuestMarksDeclinedAndIsIdempotent() throws Exception {
        ...
        BookingGuest ana = QuarkusTransaction.requiringNew().call(() ->
                BookingGuest.activeForBooking(b.id).getFirst());
