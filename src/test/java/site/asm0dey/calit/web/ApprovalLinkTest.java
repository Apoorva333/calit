...
class ApprovalLinkTest {
    ...
    BookingRef newPendingBookingForSecondOwner() {
        ...
        if (OwnerSettings.forOwner(b.id) == null) {
            ...
            s.ownerId = b.id;
            s.ownerName = "Owner B Approval";
            s.ownerEmail = "ownerb-approval@example.com";
            s.timezone = "UTC";
            s.persist();
        }
        ...
        if (t == null) {
            t = new MeetingType();
            t.ownerId = b.id;
            t.name = "B Approval Type";
            t.slug = "approval-b-type";
        ...
        if (bk == null) {
            bk = new Booking();
            bk.ownerId = ownerId;
            bk.meetingTypeId = typeId;
            bk.inviteeName = "B Guest";
            bk.inviteeEmail = "bguest@example.com";
