...
public record IcsEvent(String uid, String summary, String location,
    ...
    public static final class Builder {
        ...
        public Builder organizer(IcsBuilder.Party organizer) { this.organizer = organizer; return this; }
        ...
        public IcsEvent build() {
            return new IcsEvent(uid, summary, location, organizer, attendee,
                    start, end, method, sequence, attendeeRsvp);
        }
    }
}
